...
export type Part<T extends Schema, K extends keyof T['steps'] = keyof T['steps']> = {
  [S in keyof T['steps']]: {
    step: S
...
export type Exercise<T extends Schema, K extends keyof T['steps'] = keyof T['steps']> = {
  name: T['name']
...
export type Feedback<T extends Schema> = {
  [K in keyof T['steps']]: (
    ...
    [number, number] | keyof T['steps'] | null | [[number, number], keyof T['steps'] | null],
    any
  >
}
